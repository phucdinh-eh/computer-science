...
🚫 PASS: Miễn giảm vĩnh viễn nhờ 7 năm thực chiến.

🚨 MUST LEARN (To do - Ưu tiên cao): Trận đánh lớn bắt buộc phải thắng.

💡 NICE TO LEARN (To do - Ưu tiên thấp): Kho kiến thức bổ trợ, từ từ gặm nhấm.

🔥 IN PROGRESS: Tiêu điểm duy nhất lúc này, đang dồn 100% công lực đặt bút viết (Calculus 1A).

✅ DONE: Đã xong, tốt nghiệp môn!
...
Status | Courses | Duration | Effort | Notes | Prerequisites | Discussion
:-- | :--: | :--: | :--: | :--: | :--: | :--:
...
Status | Courses | Duration | Effort | Additional Text / Assignments| Prerequisites | Discussion
:-- | :--: | :--: | :--: | :--: | :--: | :--:
...
Status | Courses | Duration | Effort | Prerequisites | Notes
:-- | :--: | :--: | :--: | :--: | :--:
